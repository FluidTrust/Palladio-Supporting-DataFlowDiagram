...
/**
 * This is the item provider adapter for a {@link designs.metamodel.sample.metamodel.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.COMPONENT__OUTPUTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case MetamodelPackage.COMPONENT__NAME:
			...
			return;
		case MetamodelPackage.COMPONENT__OUTPUTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.COMPONENT__OUTPUTS,
				MetamodelFactory.eINSTANCE.createTerminator()));

		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.COMPONENT__OUTPUTS,
				MetamodelFactory.eINSTANCE.createProcess()));

		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.COMPONENT__OUTPUTS,
				MetamodelFactory.eINSTANCE.createStore()));
	}
