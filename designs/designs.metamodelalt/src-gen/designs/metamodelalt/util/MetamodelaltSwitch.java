 ...
 * @generated
 */
public class MetamodelaltSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamodelaltPackage.COMPONENTS: {
		...
		case MetamodelaltPackage.TERMINATOR: {
			...
			if (result == null)
				result = caseComponents(terminator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MetamodelaltPackage.FUNCTION: {
			...
			if (result == null)
				result = caseComponents(function);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
