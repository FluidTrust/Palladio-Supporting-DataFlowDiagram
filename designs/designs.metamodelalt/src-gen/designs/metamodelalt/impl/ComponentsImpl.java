 ...
 * </p>
 * <ul>
 *   <li>{@link designs.metamodelalt.impl.ComponentsImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComponentsImpl extends MinimalEObjectImpl.Container implements Components {
	...
	protected EClass eStaticClass() {
		return MetamodelaltPackage.Literals.COMPONENTS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelaltPackage.COMPONENTS__NAME, oldName, name));
	}
