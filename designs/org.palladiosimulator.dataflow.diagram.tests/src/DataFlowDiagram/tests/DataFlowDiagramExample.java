...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>DataFlowDiagram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowDiagramExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dataflowdiagram"));
				DataFlowDiagram root = DataFlowDiagramFactory.eINSTANCE.createDataFlowDiagram();
