...
import DataFlowDiagram.Component;
...
/**
 * This is the item provider adapter for a {@link DataFlowDiagram.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addIncomingDataFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_incomingDataFlow_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_incomingDataFlow_feature", "_UI_Component_type"),
				 DataFlowDiagramPackage.Literals.COMPONENT__INCOMING_DATA_FLOW,
				 true,
				 false,
				 true,
				 null,
