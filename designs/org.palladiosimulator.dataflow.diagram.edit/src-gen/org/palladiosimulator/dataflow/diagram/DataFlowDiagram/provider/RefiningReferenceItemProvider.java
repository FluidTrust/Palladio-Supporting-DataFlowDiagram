	...
	protected void addRefinedProcessesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RefiningReference_refinedProcesses_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_RefiningReference_refinedProcesses_feature", "_UI_RefiningReference_type"),
						DataFlowDiagramPackage.Literals.REFINING_REFERENCE__REFINED_PROCESSES, true, false, true, null,
						null, null));
	}
