		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_name_feature",
								"_UI_Component_type"),
						DataFlowDiagramPackage.Literals.COMPONENT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_incomingDataFlow_feature",
								"_UI_Component_type"),
						DataFlowDiagramPackage.Literals.COMPONENT__INCOMING_DATA_FLOW, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_outgoingDataFlow_feature",
								"_UI_Component_type"),
						DataFlowDiagramPackage.Literals.COMPONENT__OUTGOING_DATA_FLOW, true, false, true, null, null,
						null));
	}
