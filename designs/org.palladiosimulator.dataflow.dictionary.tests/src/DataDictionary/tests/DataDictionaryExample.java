...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>DataDictionary</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DataDictionaryExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.datadictionary"));
				DataDictionary root = DataDictionaryFactory.eINSTANCE.createDataDictionary();
