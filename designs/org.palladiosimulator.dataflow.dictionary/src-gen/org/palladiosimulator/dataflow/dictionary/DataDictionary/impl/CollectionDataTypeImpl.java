 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.dataflow.dictionary.DataDictionary.impl.CollectionDataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionDataTypeImpl extends DataTypeImpl implements CollectionDataType {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DataDictionaryPackage.COLLECTION_DATA_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataDictionaryPackage.COLLECTION_DATA_TYPE__TYPE,
					oldType, type));
	}
