...
public class DdPackageImpl extends EPackageImpl implements DdPackage {
	 ...
	 * @see designs.alternative.dd.DdPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DdPackage init() {
		...
		DdPackageImpl theDdPackage = registeredDdPackage instanceof DdPackageImpl ? (DdPackageImpl) registeredDdPackage
				: new DdPackageImpl();
	 ...
	 */
	@Override
	public EReference getDataDictionary_Elements() {
	 ...
	 */
	@Override
	public EReference getElement_Composition() {
	...
	public void createPackageContents() {
		...
		createEReference(dataDictionaryEClass, DATA_DICTIONARY__ELEMENTS);

		elementEClass = createEClass(ELEMENT);
		createEAttribute(elementEClass, ELEMENT__NAME);
		createEReference(elementEClass, ELEMENT__COMPOSITION);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDataDictionary_Elements(), this.getElement(), null, "elements", null, 0, -1,
		...
		initEReference(getElement_Composition(), this.getElement(), null, "composition", null, 0, -1, Element.class,
