...
public class DataFlowDiagramImpl extends IdentifierImpl implements DataFlowDiagram {
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this,
					DataFlowDiagramPackage.DATA_FLOW_DIAGRAM__COMPONENTS);
		}
		return components;
	}
	...
	public EList<DataFlowDiagram> getRefinedBy() {
		if (refinedBy == null) {
			refinedBy = new EObjectResolvingEList<DataFlowDiagram>(DataFlowDiagram.class, this,
					DataFlowDiagramPackage.DATA_FLOW_DIAGRAM__REFINED_BY);
		}
		return refinedBy;
	}
	...
	public NotificationChain basicSetRefines(RefiningReference newRefines, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DataFlowDiagramPackage.DATA_FLOW_DIAGRAM__REFINES, oldRefines, newRefines);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRefines != refines) {
			...
			if (refines != null)
				msgs = ((InternalEObject) refines).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DataFlowDiagramPackage.DATA_FLOW_DIAGRAM__REFINES, null, msgs);
			if (newRefines != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DataFlowDiagramPackage.DATA_FLOW_DIAGRAM__REFINES,
