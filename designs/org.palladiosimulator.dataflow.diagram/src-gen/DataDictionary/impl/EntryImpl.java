...
import DataDictionary.DataType;
 ...
 * </p>
 * <ul>
 *   <li>{@link DataDictionary.impl.EntryImpl#getType <em>Type</em>}</li>
 *   <li>{@link DataDictionary.impl.EntryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntryImpl extends IdentifierImpl implements Entry {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataDictionaryPackage.ENTRY__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataDictionaryPackage.ENTRY__TYPE, oldType, type));
	}
