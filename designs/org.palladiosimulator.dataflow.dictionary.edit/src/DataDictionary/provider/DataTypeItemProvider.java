...
/**
 * This is the item provider adapter for a {@link DataDictionary.DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataTypeItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataDictionaryPackage.Literals.DATA_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataType.class)) {
			case DataDictionaryPackage.DATA_TYPE__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return DataDictionaryEditPlugin.INSTANCE;
	}
