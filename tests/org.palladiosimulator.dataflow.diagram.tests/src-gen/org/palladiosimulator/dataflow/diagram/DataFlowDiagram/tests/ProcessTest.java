...
public class ProcessTest extends NodeTest {
	 ...
	 */
	@Override
	protected org.palladiosimulator.dataflow.diagram.DataFlowDiagram.Process getFixture() {
		return (org.palladiosimulator.dataflow.diagram.DataFlowDiagram.Process)fixture;
	}
