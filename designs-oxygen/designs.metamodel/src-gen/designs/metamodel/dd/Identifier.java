 ...
 * </p>
 * <ul>
 *   <li>{@link designs.metamodel.dd.Identifier#getId <em>Id</em>}</li>
 * </ul>
 *
 * @see designs.metamodel.dd.DdPackage#getIdentifier()
 * @model abstract="true"
...
public interface Identifier extends EObject {
	 ...
	 * @see #setId(String)
	 * @see designs.metamodel.dd.DdPackage#getIdentifier_Id()
	...
	/**
	 * Sets the value of the '{@link designs.metamodel.dd.Identifier#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
