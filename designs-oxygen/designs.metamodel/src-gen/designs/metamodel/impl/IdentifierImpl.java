 ...
 * </p>
 * <ul>
 *   <li>{@link designs.metamodel.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifierImpl extends MinimalEObjectImpl.Container implements Identifier {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.IDENTIFIER;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.IDENTIFIER__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MetamodelPackage.IDENTIFIER__ID:
			return getId();
		}
