...
public class MetamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamodelPackage.DATA_FLOW_DIAGRAM: {
			...
			if (result == null)
				result = caseIdentifier(dataFlowDiagram);
			if (result == null)
		...
		case MetamodelPackage.PROCESS: {
			designs.metamodel.Process process = (designs.metamodel.Process) theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(designs.metamodel.Process object) {
		return null;
	}
