...
/**
 * This is the item provider adapter for a {@link designs.metamodel.DataFlowDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowDiagramItemProvider extends IdentifierItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__COMPONENT);
			childrenFeatures.add(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__REFINES);
			childrenFeatures.add(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__REFINED_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__COMPONENT,
				MetamodelFactory.eINSTANCE.createExternalActor()));

		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__COMPONENT,
				MetamodelFactory.eINSTANCE.createStore()));

		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.DATA_FLOW_DIAGRAM__COMPONENT,
				MetamodelFactory.eINSTANCE.createPort()));
