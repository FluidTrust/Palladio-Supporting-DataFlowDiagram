...
/**
 * This is the item provider adapter for a {@link designs.metamodel.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends IdentifierItemProvider {
	...
	protected void addIncomingDataFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Component_incomingDataFlow_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Component_incomingDataFlow_feature",
								"_UI_Component_type"),
						MetamodelPackage.Literals.COMPONENT__INCOMING_DATA_FLOW, true, false, true, null, null, null));
	}
	...
	protected void addOutgoingDataFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Component_outgoingDataFlow_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Component_outgoingDataFlow_feature",
								"_UI_Component_type"),
						MetamodelPackage.Literals.COMPONENT__OUTGOING_DATA_FLOW, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_name_feature",
								"_UI_Component_type"),
						MetamodelPackage.Literals.COMPONENT__NAME, true, false, false,
