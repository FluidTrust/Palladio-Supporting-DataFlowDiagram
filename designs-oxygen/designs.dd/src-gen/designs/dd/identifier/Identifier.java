 ...
 * </p>
 * <ul>
 *   <li>{@link designs.dd.identifier.Identifier#getId <em>Id</em>}</li>
 * </ul>
 *
 * @see designs.dd.identifier.IdentifierPackage#getIdentifier()
 * @model abstract="true"
...
public interface Identifier extends EObject {
	 ...
	 * @see #setId(String)
	 * @see designs.dd.identifier.IdentifierPackage#getIdentifier_Id()
	...
	/**
	 * Sets the value of the '{@link designs.dd.identifier.Identifier#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
