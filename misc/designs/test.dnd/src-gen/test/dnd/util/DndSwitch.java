 ...
 * @generated
 */
public class DndSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DndPackage.CHILD: {
			...
			if (result == null)
				result = caseComponent(child);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DndPackage.DN_D: {
			DnD dnD = (DnD) theEObject;
			T result = caseDnD(dnD);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DndPackage.COMPONENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dn D</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dn D</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDnD(DnD object) {
		return null;
	}
